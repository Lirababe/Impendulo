...
{
    public partial class frmEmailMessage : MetroForm
    {
        ...
        private void frmEmailMessage_Load(object sender, EventArgs e)
        {
            this.IsSent = false;
        ...
        {
            using (frmSelectEmailContacts frm = new frmSelectEmailContacts())
            {
