...
namespace Impendulo.Common.ScheduleAvailablityAlgorithm
{
    public class SchedulingDateSearchAlgorithms
    {
        ...
        public class CourseAvailableDateSet
        {
            ...
            public CourseAvailableDateSet(string CourseName, int FacilitatorID, int CurriculumCourseID, DateTime StartDate, DateTime EndDate)
            {
        ...
        public void SetPossibleCurriculumCourseDates()
        {
            ...
            foreach (FacilitatorAvailableDateSet FADS in FacilitatorAvailableDateSets)
            {
                ...
                while (FIRST_DAY_CAN_BE_SCHEDULED_FROM_SET.Date < FADS.EndDate.Date)
                {
                    ...
                    DateTime EndDateForCurrentPossibleSchedule = CustomDateTime.getCustomDateTime(FIRST_DAY_CAN_BE_SCHEDULED_FROM_SET, CC.Duration, EnumDayOfWeeksList);
