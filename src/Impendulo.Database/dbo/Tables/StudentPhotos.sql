CREATE TABLE [dbo].[StudentPhotos] (
    ...
    CONSTRAINT [FK_StudentPhotos_Files] FOREIGN KEY ([ImageID]) REFERENCES [dbo].[Files] ([ImageID]),
    CONSTRAINT [FK_StudentPhotos_Students] FOREIGN KEY ([IndividualID]) REFERENCES [dbo].[Students] ([IndividualID])
);
